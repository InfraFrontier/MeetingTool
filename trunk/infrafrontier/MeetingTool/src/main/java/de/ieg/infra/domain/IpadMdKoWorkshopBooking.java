...
public class IpadMdKoWorkshopBooking extends Booking {
private List<String> numberOfNightsEuropeanParticipants;
private List<String> numberOfNightsNonEuropeanParticipants;
...
private String flightBookedByInfrafrontier;
	...
	public List<String> getNumberOfNightsEuropeanParticipants() {
		return numberOfNightsEuropeanParticipants;
	}

	public void setNumberOfNightsEuropeanParticipants(
			List<String> numberOfNightsEuropeanParticipants) {
		this.numberOfNightsEuropeanParticipants = numberOfNightsEuropeanParticipants;
	}

	public List<String> getNumberOfNightsNonEuropeanParticipants() {
		return numberOfNightsNonEuropeanParticipants;
	}

	public void setNumberOfNightsNonEuropeanParticipants(
			List<String> numberOfNightsNonEuropeanParticipants) {
		this.numberOfNightsNonEuropeanParticipants = numberOfNightsNonEuropeanParticipants;
	}
	...
	public void setFlightBookedByOwnInstitution(
			String flightBookedByOwnInstitution) {
	...
	public void setFlightBookedByInfrafrontier(
			String flightBookedByInfrafrontier) {
		this.flightBookedByInfrafrontier = flightBookedByInfrafrontier;
	}

	public boolean isFlightBookedInfra() {
		return flightBookedByInfrafrontier != null
				&& flightBookedByInfrafrontier.equals("yes") ? true : false;
	}

	public String getOutboundFlightTime() {
		this.outboundFlightHour = this.outboundFlightHour == null
				|| this.outboundFlightHour.equals("-please_select-") ? ""
				: this.outboundFlightHour;

		this.outboundFlightMinute = this.outboundFlightMinute == null
				|| this.outboundFlightMinute.equals("-please_select-") ? ""
				: this.outboundFlightMinute;

		outboundFlightTime = this.outboundFlightHour + ":"
				+ this.outboundFlightMinute;
	...
	public String getReturnFlightTime() {
		this.returnFlightHour = this.returnFlightHour == null
				|| this.returnFlightHour.equals("-please_select-") ? ""
				: this.returnFlightHour;

		this.returnFlightMinute = this.returnFlightMinute == null
				|| this.returnFlightMinute.equals("-please_select-") ? ""
				: this.returnFlightMinute;
		returnFlightTime = this.returnFlightHour + ":"
				+ this.returnFlightMinute;
