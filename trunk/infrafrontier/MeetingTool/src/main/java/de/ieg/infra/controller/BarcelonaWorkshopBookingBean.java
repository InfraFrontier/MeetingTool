...
public class BarcelonaWorkshopBookingBean extends BookingBean {

	private BarcelonaWorkshopBooking booking=new BarcelonaWorkshopBooking();
	 ...
	 * @return
	 */
	public BarcelonaWorkshopBooking getBooking() {
		return booking;
	 ...
	 * @param booking
	 */
	public void setBooking(BarcelonaWorkshopBooking booking) {
	...
	public void bookEvent(ActionEvent ev){
		try {
			...
			event.setBooking(booking);
                        bookingDao.insertBarcelonaWorkshopBooking(event.getId(), booking);
			...
			booking=new BarcelonaWorkshopBooking();
		}
		catch(Exception ex) {
