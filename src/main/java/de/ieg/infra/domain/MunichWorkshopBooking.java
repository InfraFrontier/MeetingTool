...
public class MunichWorkshopBooking extends Booking{
	private List<String> numberOfNightsEuropeans;

private List<String> numberOfNightsNonEuropeans;
...
public void setSex(String sex) {
	...
	public List<String> getNumberOfNightsEuropeans() {
		return numberOfNightsEuropeans;

}
	public void setNumberOfNightsEuropeans(List<String> numberOfNightsEuropeans) {
		this.numberOfNightsEuropeans = numberOfNightsEuropeans;

}
	public List<String> getNumberOfNightsNonEuropeans() {
		return numberOfNightsNonEuropeans;

}
	public void setNumberOfNightsNonEuropeans(
			List<String> numberOfNightsNonEuropeans) {
		this.numberOfNightsNonEuropeans = numberOfNightsNonEuropeans;
