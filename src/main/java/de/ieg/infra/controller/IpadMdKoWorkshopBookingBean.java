...
public class IpadMdKoWorkshopBookingBean extends BookingBean {
	private IpadMdKoWorkshopBooking booking=new IpadMdKoWorkshopBooking();

	/**
	 * Returns a booking
	 * @return
	 */
	public IpadMdKoWorkshopBooking getBooking() {
		return booking;
	}
	 ...
	 * @param booking
	 */
	public void setBooking(IpadMdKoWorkshopBooking booking) {
	...
	public String generateEmailConfirmationText(){
		...
		text.append(booking.getNumberOfNightsEuropeanParticipants()!=null?booking.getNumberOfNightsEuropeanParticipants().toString():null);
		text.append("\r\n");
		text.append(booking.getNumberOfNightsNonEuropeanParticipants()!=null?booking.getNumberOfNightsNonEuropeanParticipants().toString():null);
		text.append("\r\n");
		text.append("\r\n");
	...
	public  String generateBookingText(){
		...
		text.append(booking.getAccommodationYesNo());
		text.append("\t");
		text.append(booking.getNumberOfNightsEuropeanParticipants()!=null?"Number of Nights European Participants:" +booking.getNumberOfNightsEuropeanParticipants().toString():null);
		text.append("\t");
		text.append(booking.getNumberOfNightsNonEuropeanParticipants()!=null?"Number of Nights Non European Participants:" +booking.getNumberOfNightsNonEuropeanParticipants().toString():null);
		text.append("\t");
		text.append(booking.getFlightBookedByOwnInstitution());
		text.append("\t");
		text.append(booking.getFlightBookedByInfrafrontier());
	...
	public void bookEvent(ActionEvent ev){
		try {
			...
			booking=new IpadMdKoWorkshopBooking();
		}
		catch(Exception ex) {
